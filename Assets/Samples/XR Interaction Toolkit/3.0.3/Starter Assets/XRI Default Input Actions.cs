...
public partial class @XRIDefaultInputActions: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        ...
        {
            ""name"": ""XR A Control"",
            ""id"": ""8d7ad2b3-6d0a-4459-a27f-b4e8960540d0"",
            ""actions"": [
                {
                    ""name"": ""Record button"",
                    ""type"": ""Button"",
                    ""id"": ""02639919-809f-4367-b874-e806115dce82"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""79e107d1-59f4-4768-a0e7-d40a9f41d73c"",
                    ""path"": ""<XRController>{RightHand}/{TriggerButton}"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
    ...
    ""controlSchemes"": []
        ...
        // XR A Control
        m_XRAControl = asset.FindActionMap("XR A Control", throwIfNotFound: true);
        m_XRAControl_Recordbutton = m_XRAControl.FindAction("Record button", throwIfNotFound: true);
    }
    ...
    ~@XRIDefaultInputActions()
    {
        ...
        UnityEngine.Debug.Assert(!m_XRAControl.enabled, "This will cause a leak and performance issues, XRIDefaultInputActions.XRAControl.Disable() has not been called.");
    }
    ...
    // XR A Control
    private readonly InputActionMap m_XRAControl;
    private List<IXRAControlActions> m_XRAControlActionsCallbackInterfaces = new List<IXRAControlActions>();
    private readonly InputAction m_XRAControl_Recordbutton;
    public struct XRAControlActions
    {
        private @XRIDefaultInputActions m_Wrapper;
        public XRAControlActions(@XRIDefaultInputActions wrapper) { m_Wrapper = wrapper; }
        public InputAction @Recordbutton => m_Wrapper.m_XRAControl_Recordbutton;
        public InputActionMap Get() { return m_Wrapper.m_XRAControl; }
        public void Enable() { Get().Enable(); }
        public void Disable() { Get().Disable(); }
        public bool enabled => Get().enabled;
        public static implicit operator InputActionMap(XRAControlActions set) { return set.Get(); }
        public void AddCallbacks(IXRAControlActions instance)
        {
            if (instance == null || m_Wrapper.m_XRAControlActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_XRAControlActionsCallbackInterfaces.Add(instance);
        ...
        private void UnregisterCallbacks(IXRAControlActions instance)
        {
            @Recordbutton.started -= instance.OnRecordbutton;
            @Recordbutton.performed -= instance.OnRecordbutton;
            @Recordbutton.canceled -= instance.OnRecordbutton;
        ...
        public void RemoveCallbacks(IXRAControlActions instance)
        {
            if (m_Wrapper.m_XRAControlActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }

        public void SetCallbacks(IXRAControlActions instance)
        {
            foreach (var item in m_Wrapper.m_XRAControlActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_XRAControlActionsCallbackInterfaces.Clear();
            AddCallbacks(instance);
        }
    }
    public XRAControlActions @XRAControl => new XRAControlActions(this);
    ...
    public interface IXRAControlActions
    {
